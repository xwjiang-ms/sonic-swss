...
SAI_OUTBOUND_CA_TO_PA_ENTRY_ATTR_DASH_TUNNEL_ID = 'SAI_OUTBOUND_CA_TO_PA_ENTRY_ATTR_DASH_TUNNEL_ID'
SAI_DASH_ENCAPSULATION_NVGRE = 'SAI_DASH_ENCAPSULATION_NVGRE'
SAI_DASH_ENCAPSULATION_VXLAN = 'SAI_DASH_ENCAPSULATION_VXLAN'

SAI_OUTBOUND_ROUTING_ENTRY_ATTR_UNDERLAY_SIP = 'SAI_OUTBOUND_ROUTING_ENTRY_ATTR_UNDERLAY_SIP'

SAI_DASH_TUNNEL_ATTR_DIP = 'SAI_DASH_TUNNEL_ATTR_DIP'
SAI_DASH_TUNNEL_ATTR_DASH_ENCAPSULATION = 'SAI_DASH_TUNNEL_ATTR_DASH_ENCAPSULATION'
SAI_DASH_TUNNEL_ATTR_TUNNEL_KEY = 'SAI_DASH_TUNNEL_ATTR_TUNNEL_KEY'
SAI_DASH_TUNNEL_ATTR_MAX_MEMBER_SIZE = 'SAI_DASH_TUNNEL_ATTR_MAX_MEMBER_SIZE'
SAI_DASH_TUNNEL_ATTR_SIP = 'SAI_DASH_TUNNEL_ATTR_SIP'

SAI_DASH_TUNNEL_NEXT_HOP_ATTR_DIP = 'SAI_DASH_TUNNEL_NEXT_HOP_ATTR_DIP'

SAI_DASH_TUNNEL_MEMBER_ATTR_DASH_TUNNEL_ID = 'SAI_DASH_TUNNEL_MEMBER_ATTR_DASH_TUNNEL_ID'
SAI_DASH_TUNNEL_MEMBER_ATTR_DASH_TUNNEL_NEXT_HOP_ID = 'SAI_DASH_TUNNEL_MEMBER_ATTR_DASH_TUNNEL_NEXT_HOP_ID'
